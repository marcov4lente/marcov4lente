...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="app.css"  media="screen,projection"/>
    ...
    <body>
            ...
            <div class="container">
                <div class="nav-wrapper">
                    <a href="/" class="brand-logo">
                        <img src="img/marcov4lente-logo.png" alt="MarcoV4lente">
                    </a>
            ...
            <div class="container">
                <div class="col s12">
                    <div class="section white-text">
                        <img class="hero-avatar" src="img/Marco-Valente-Avatar.jpg" alt="Marco V4lente Avatar">
        ...
        <footer class="page-footer white">
            <div class="section blue-grey-text text-darken-2">
